...
>
  <section class="page-header" data-screen-label="01 Header" style="min-height:40vh">
    ...
    <dl class="page-header__meta"><div><dt>Effective</dt><dd>01 May 2026</dd></div><div><dt>Version</dt><dd>3.2</dd></div></dl>
  </section>
  <section class="section"><div class="wrap"><div class="legal">
    ...
    <h2>4. Your rights</h2>
    <p>You may access, correct, or delete your data at any time. Reach out at <a href="mailto:{{ \App\Models\SiteSetting::get('contact_email', 'hello@thelastclicks.com') }}">{{ \App\Models\SiteSetting::get('contact_email', 'hello@thelastclicks.com') }}</a>.</p>
    <h2>5. Retention</h2>
