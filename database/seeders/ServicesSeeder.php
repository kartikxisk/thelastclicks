    ...
    public function run(): void
    {
        ...
        $services = [
            'videography' => [
                ...
                'phases' => [
                    ['num' => '01', 'title' => 'Treatment', 'desc' => 'Director-written and heavily researched. Visualised with distinct references and shot grammar — the entire film architected before a single camera is packed.'],
                    ['num' => '02', 'title' => 'Pre-pro', 'desc' => 'Logistics locked. Casting, location scouting, scheduling, art direction and kit lists are finalised. The call sheet is strictly enforced.'],
                    ['num' => '03', 'title' => 'Production', 'desc' => 'Our crews deploy. Absolute set discipline, live on-set monitoring, and daily rushes delivered by 9 PM.'],
                    ['num' => '04', 'title' => 'Edit', 'desc' => 'A highly structured post pipeline. Paper edit → rough cut → fine cut, managed through three consolidated feedback rounds.'],
                    ['num' => '05', 'title' => 'Finish', 'desc' => 'The final polish. ACES colour grading, broadcast-compliant sound design, and masters rendered for every specific platform requirement.'],
                ],
            ...
            'photography' => [
                ...
                'phases' => [
                    ['num' => '01', 'title' => 'Creative direction', 'desc' => 'Visual strategy locked. We develop comprehensive mood boards, lighting diagrams and shot lists to align perfectly with your campaign goals.'],
                    ['num' => '02', 'title' => 'Pre-pro', 'desc' => 'Logistics secured. Location scouting, casting, art direction and exact technical kit lists are finalised before stepping on set.'],
                    ['num' => '03', 'title' => 'The shoot', 'desc' => 'Our units deploy. Absolute set discipline, tethered live-monitoring for instant client feedback, and rigorous adherence to the shot list.'],
                    ['num' => '04', 'title' => 'Selection', 'desc' => 'Curated contact sheets delivered. We provide a streamlined, secure review process for your team to make final selects without the friction.'],
                    ['num' => '05', 'title' => 'Retouching', 'desc' => 'Studio-grade finishing. High-end skin retouching, colour matching to exact brand hex codes, and final delivery in both print and web-ready formats.'],
                ],
                // Galleries are uploaded through the admin — nothing is seeded.
                'gallery_urls' => [],
                'kit' => [
            ...
            'editing' => [
                ...
                'phases' => [
                    ['num' => '01', 'title' => 'Ingest & sync', 'desc' => 'Data wrangling and security. Footage is backed up to redundant servers, multi-cam angles are synced, and proxies are generated.'],
                    ['num' => '02', 'title' => 'Offline edit', 'desc' => 'The narrative assembly. We cut for pacing, rhythm and story structure. Delivered as a rough cut for your initial structural approval.'],
                    ['num' => '03', 'title' => 'Online & VFX', 'desc' => 'The cleanup phase. Picture lock is achieved. Motion graphics, titling and any necessary plate cleanups are integrated seamlessly.'],
                    ['num' => '04', 'title' => 'Colour & sound', 'desc' => 'The final polish. ACES colour grading for cinematic depth, paired with broadcast-compliant audio mixing and sound design.'],
                    ['num' => '05', 'title' => 'Mastering', 'desc' => 'Rendered for deployment. We deliver exact platform specs (16:9, 9:16, 4:5), ensuring pristine compression for web, broadcast and internal archives.'],
                ],
                // Galleries are uploaded through the admin — nothing is seeded.
                'gallery_urls' => [],
                'kit' => [
