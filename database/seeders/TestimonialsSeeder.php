...
class TestimonialsSeeder extends Seeder
{
    ...
    {
        $rows = [
            ['TheLastClicks delivered exceptional coverage for our annual conference. Their professionalism and attention to detail made all the difference.', 'Priya Mehta', 'Marketing Head, Fortune 500 FMCG', 'corporate-events'],
