...
window.TLC = (function(){
  ...
  const NAV_LINKS = [
    ...
    { href: 'our-process.html', label: 'Our Process' },
    { href: 'portfolio.html', label: 'Portfolio' },
    { href: 'talent.html', label: 'Talent' },
  ...
  function navHTML() {
    return `
    <header class="nav">
      <a class="nav__brand" href="index.html" data-cursor="HOME">
      ...
      <div class="wrap">
        ...
        <div class="foot__grid">
          ...
          <div class="foot__col">
            ...
            <a href="portfolio.html#weddings">Weddings</a>
            <a href="portfolio.html#brands">Brand films</a>
          ...
          <form class="quote__form" autocomplete="off">
            ...
            <section class="quote__panel-step quote__success" data-panel="4">
              ...
              <div class="quote__success-actions">
                <a class="btn" href="portfolio.html"><span>See the reel</span><span class="arr"></span></a>
    ...
    <div class="cookies" role="dialog" aria-label="Cookie consent" aria-hidden="true">
      <div class="cookies__inner">
        <div class="cookies__copy">
          ...
          <p>We use a few small cookies to make this site work and to understand which essays land. Read the <a href="cookie-policy.html">cookie policy</a> or pick below.</p>
        </div>
  ...
  function mount(opts = {}) {
    ...
    const navNodes = Array.from(navWrap.childNodes);
    navNodes.reverse().forEach(n => document.body.insertBefore(n, document.body.firstChild));
